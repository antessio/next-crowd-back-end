...
public class CrowdfundingProjectSpringDataRepositoryAdapter implements CrowdfundingProjectRepository {
    ...
    private final nextcrowd.crowdfunding.infrastructure.domain.project.persistence.CrowdfundingProjectRepository crowdfundingProjectRepository;
    private final ProjectOwnerRepository projectOwnerRepository;
    private final InvestmentRepository investmentRepository;

    public CrowdfundingProjectSpringDataRepositoryAdapter(
            nextcrowd.crowdfunding.infrastructure.domain.project.persistence.CrowdfundingProjectRepository crowdfundingProjectRepository,
