...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVESTMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVESTMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVESTMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INVESTMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INVESTMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVESTMENT actions', async () => {
      const arg = 42666;
