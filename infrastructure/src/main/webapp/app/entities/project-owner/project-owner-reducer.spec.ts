...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTOWNER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTOWNER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTOWNER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROJECTOWNER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTOWNER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROJECTOWNER actions', async () => {
      const arg = 42666;
