...
/**
 * REST controller for managing {@link nextcrowd.crowdfunding.domain.CrowdfundingProject}.
 */
@RestController
    ...
    public ResponseEntity<CrowdfundingProject> partialUpdateCrowdfundingProject(
        ...
        Optional<CrowdfundingProject> result = crowdfundingProjectRepository
            ...
            .map(existingCrowdfundingProject -> {
                ...
                if (crowdfundingProject.getSummary() != null) {
                    existingCrowdfundingProject.setSummary(crowdfundingProject.getSummary());
                }
