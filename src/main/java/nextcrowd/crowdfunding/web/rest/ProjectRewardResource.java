...
/**
 * REST controller for managing {@link nextcrowd.crowdfunding.domain.ProjectReward}.
 */
@RestController
...
public class ProjectRewardResource {
     ...
     */
    @GetMapping("")
    public List<ProjectReward> getAllProjectRewards() {
        LOG.debug("REST request to get all ProjectRewards");
