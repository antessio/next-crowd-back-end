...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ICrowdfundingProject, thunkAPI) => {
    return axios.post<ICrowdfundingProject>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ICrowdfundingProject, thunkAPI) => {
    return axios.put<ICrowdfundingProject>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ICrowdfundingProject, thunkAPI) => {
    return axios.patch<ICrowdfundingProject>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<ICrowdfundingProject>(requestUrl);
  },
  { serializeError: serializeAxiosError },
);
