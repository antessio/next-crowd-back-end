...
import reducer, {
  ...
  reset,
  updateEntity,
} from './crowdfunding-project.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CROWDFUNDINGPROJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CROWDFUNDINGPROJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CROWDFUNDINGPROJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CROWDFUNDINGPROJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CROWDFUNDINGPROJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CROWDFUNDINGPROJECT actions', async () => {
      const arg = 42666;
