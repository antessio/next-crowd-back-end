...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTREWARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTREWARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTREWARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROJECTREWARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTREWARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROJECTREWARD actions', async () => {
      const arg = 42666;
