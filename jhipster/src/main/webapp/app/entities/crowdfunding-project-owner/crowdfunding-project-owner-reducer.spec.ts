...
import reducer, {
  ...
  reset,
  updateEntity,
} from './crowdfunding-project-owner.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CROWDFUNDINGPROJECTOWNER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CROWDFUNDINGPROJECTOWNER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CROWDFUNDINGPROJECTOWNER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CROWDFUNDINGPROJECTOWNER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CROWDFUNDINGPROJECTOWNER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CROWDFUNDINGPROJECTOWNER actions', async () => {
      const arg = 42666;
